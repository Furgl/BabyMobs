...
@Mod(modid = BabyMobs.MODID, name = BabyMobs.MODNAME, version = BabyMobs.VERSION, guiFactory = "furgl.babyMobs.client.gui.config.BabyMobsGuiFactory", updateJSON = "https://raw.githubusercontent.com/Furgl/BabyMobs/1.10.2/update.json")
