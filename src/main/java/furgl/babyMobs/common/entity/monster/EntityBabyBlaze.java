		...
		if (Config.useSpecialAbilities) 
		{
			...
			if (this.dataManager.get(FLAMETHROWER) == 1 && this.getHealth() > 0)
			{
				...
				if (this.ticksExisted % 10 == 0)
					this.world.playSound(this.posX + 0.5D, this.posY + 0.5D, this.posZ + 0.5D, SoundEvents.ENTITY_GHAST_SHOOT, this.getSoundCategory(), 1.0F, this.rand.nextFloat() * 0.2F + 0.0F, false);
				...
				{
					EntitySpawner entitySpawner = new EntitySpawner(EntityBlazeFlamethrower.class, world, vec, 1);
