...
public class EntityBabySkeleton extends EntityMob implements IRangedAttackMob
{
    ...
    public EntityBabySkeleton(World p_i1741_1_)
    {
        super(p_i1741_1_);
  ...
  //TODO when attacked give effect
	...
	public void attackEntityWithRangedAttack(EntityLivingBase p_82196_1_, float p_82196_2_)
    {
    	//TODO changed to EntitySkeletonArrow from EntityArrow
    			if (Config.useSpecialAbilities)
    			{
    				EntitySkeletonArrow entityarrow = new EntitySkeletonArrow(this.worldObj, this, p_82196_1_, 1.6F, 14 - this.worldObj.difficultySetting.getDifficultyId() * 4);
