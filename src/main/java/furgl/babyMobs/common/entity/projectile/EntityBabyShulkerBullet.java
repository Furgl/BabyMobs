...
public class EntityBabyShulkerBullet extends EntityShulkerBullet 
{
	...
	public void onUpdate()
	{
		...
		this.world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.posX, this.posY, this.posZ, (this.rand.nextDouble() - 0.5D)*0.1D, (this.rand.nextDouble() - 0.5D)*0.1D, (this.rand.nextDouble() - 0.5D)*0.1D, null);
		this.world.spawnParticle(EnumParticleTypes.SMOKE_NORMAL, this.posX, this.posY, this.posZ, (this.rand.nextDouble() - 0.5D)*0.1D, (this.rand.nextDouble() - 0.5D)*0.1D, (this.rand.nextDouble() - 0.5D)*0.1D, null);
	}
