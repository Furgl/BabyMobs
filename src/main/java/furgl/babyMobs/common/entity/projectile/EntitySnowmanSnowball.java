...
public class EntitySnowmanSnowball extends EntityThrowable
{
	...
	public EntitySnowmanSnowball(World world, EntityLivingBase entitylivingbase) 
	{
	...
	public void onUpdate()
	{
		...
		{
			for (int i=0; i<2; i++)
				this.world.spawnParticle(EnumParticleTypes.SNOW_SHOVEL, this.posX+(this.rand.nextDouble()-0.5D), this.posY+(this.rand.nextDouble()-0.5D), this.posZ+(this.rand.nextDouble()-0.5D), 0, 0.1D, 0, new int[0]);
		}
	}
