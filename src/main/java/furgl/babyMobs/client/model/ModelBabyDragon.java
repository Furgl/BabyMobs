...
public class ModelBabyDragon extends ModelBase
{
	...
	public ModelBabyDragon(float p_i46360_1_)
	{
		...
		this.setTextureOffset("body.glScalef", 220, 53);
		this.setTextureOffset("head.glScalef", 0, 0);
		this.setTextureOffset("neck.glScalef", 48, 0);
		...
		this.head.addBox("glScalef", -5.0F, -12.0F, 12.0F + f1, 2, 4, 6);
		this.head.addBox("nostril", -5.0F, -3.0F, -6.0F + f1, 2, 2, 4);
		this.head.mirror = false;
		this.head.addBox("glScalef", 3.0F, -12.0F, 12.0F + f1, 2, 4, 6);
		...
		this.spine.addBox("glScalef", -1.0F, -9.0F, -3.0F, 2, 4, 6);
		this.body = new ModelRenderer(this, "body");
		this.body.setRotationPoint(0.0F, 4.0F, 8.0F);
		this.body.addBox("body", -12.0F, 0.0F, -16.0F, 24, 24, 64);
		this.body.addBox("glScalef", -1.0F, -6.0F, -10.0F, 2, 6, 12);
		this.body.addBox("glScalef", -1.0F, -6.0F, 10.0F, 2, 6, 12);
		this.body.addBox("glScalef", -1.0F, -6.0F, 30.0F, 2, 6, 12);
	...
	public void render(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
	{
		...
		float glScalefFactor = 0.1F; 
		GL11.glPushMatrix();
		GL11.glTranslatef(0F, 1.5F-1.5F*glScalefFactor, 0F);
		GL11.glScalef(glScalefFactor, glScalefFactor, glScalefFactor);

		EntityBabyDragon EntityBabyDragon = (EntityBabyDragon)p_78088_1_;
		float f6 = EntityBabyDragon.prevAnimTime + (EntityBabyDragon.animTime - EntityBabyDragon.prevAnimTime) * this.partialTicks;
		...
		float f12 = this.updateRotations(EntityBabyDragon.getMovementOffsets(5, this.partialTicks)[0] - EntityBabyDragon.getMovementOffsets(10, this.partialTicks)[0]);
		float f13 = this.updateRotations(EntityBabyDragon.getMovementOffsets(5, this.partialTicks)[0] + f12 / 2.0F);
		f8 += 2.0F;
		...
		for (int i = 0; i < 5; ++i)
		{
			...
			this.spine.rotateAngleZ = -this.updateRotations(adouble1[0] - f13) * (float)Math.PI / 180.0F * f11;
		...
		this.head.rotateAngleZ = -this.updateRotations(adouble2[0] - f13) * (float)Math.PI / 180.0F * 1.0F;
		...
		for (int k = 0; k < 12; ++k)
		{
			...
			this.spine.rotateAngleZ = this.updateRotations(adouble2[0] - f13) * (float)Math.PI / 180.0F * f11;
			this.spine.rotationPointY = f8;
			this.spine.rotationPointZ = f9;
			this.spine.rotationPointX = f10;
			f8 = (float)(f8 + Math.sin(this.spine.rotateAngleX) * 10.0D);
