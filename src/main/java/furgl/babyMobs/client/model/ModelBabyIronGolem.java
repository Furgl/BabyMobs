...
public class ModelBabyIronGolem extends ModelBase
{
    ...
    {
        EntityBabyIronGolem EntityBabyIronGolem = (EntityBabyIronGolem)p_78086_1_;
        int i = EntityBabyIronGolem.getAttackTimer();
        ...
        {
            int j = EntityBabyIronGolem.getHoldRoseTick();
