...
public class ModelBabyOcelot extends ModelBase
{
    ...
    {
        EntityBabyOcelot EntityBabyOcelot = (EntityBabyOcelot)p_78086_1_;
        ...
        if (EntityBabyOcelot.isSneaking())
        {
        ...
        else if (EntityBabyOcelot.isSprinting())
        {
        ...
        else if (EntityBabyOcelot.isSitting())
        {
