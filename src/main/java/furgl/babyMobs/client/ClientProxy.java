...
{	
	...
	{ 
		EntitySpawner spawner = new EntitySpawner(EntityDragonParticlesFX.class, entityBabyDragon.world, new Vec3d(entityBabyDragon.dragonEgg.xCoord+0.5D, entityBabyDragon.dragonEgg.yCoord, entityBabyDragon.dragonEgg.zCoord+0.5D), 10);
