...
public class LayerHeldItemBabyWitch implements LayerRenderer
{
    private final RenderBabyWitch field_177144_a;

    public LayerHeldItemBabyWitch(RenderBabyWitch p_i46106_1_)
    {
        this.field_177144_a = p_i46106_1_;
    }

    public void func_177143_a(EntityBabyWitch p_177143_1_, float p_177143_2_, float p_177143_3_, float p_177143_4_, float p_177143_5_, float p_177143_6_, float p_177143_7_, float p_177143_8_)
    {
        ...
        if (itemstack != null)
        {
            ...
            ((ModelBabyWitch)this.field_177144_a.getMainModel()).villagerNose.postRender(0.0625F);
    ...
    {
        this.func_177143_a((EntityBabyWitch)p_177141_1_, p_177141_2_, p_177141_3_, p_177141_4_, p_177141_5_, p_177141_6_, p_177141_7_, p_177141_8_);
    }
}