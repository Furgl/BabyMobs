...
public class RenderBabyDragon extends RenderLiving
{
    ...
    public RenderBabyDragon()
    {
        super(new ModelBabyDragon(0.0F), 0.5F);
        this.ModelBabyDragon = (ModelBabyDragon)this.mainModel;
        this.setRenderPassModel(this.mainModel);
    }

    protected void rotateCorpse(EntityBabyDragon p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
     ...
     */
    public void doRender(EntityBabyDragon p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
...
/*
     ...
     */
    protected ResourceLocation getEntityTexture(EntityBabyDragon p_110775_1_)
    {
        return enderDragonTextures;
    }

    protected void renderEquippedItems(EntityBabyDragon p_77029_1_, float p_77029_2_)
    {
     ...
     */
    protected int shouldRenderPass(EntityBabyDragon p_77032_1_, int p_77032_2_, float p_77032_3_)
    {
        if (p_77032_2_ == 1)
        {
            GL11.glDepthFunc(GL11.GL_LEQUAL);
    ...
    {
        this.doRender((EntityBabyDragon)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        return this.shouldRenderPass((EntityBabyDragon)p_77032_1_, p_77032_2_, p_77032_3_);
    }

    @Override
	protected void renderEquippedItems(EntityLivingBase p_77029_1_, float p_77029_2_)
    {
        this.renderEquippedItems((EntityBabyDragon)p_77029_1_, p_77029_2_);
    }

    @Override
	protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        this.rotateCorpse((EntityBabyDragon)p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);
    }
    ...
    {
        return this.getEntityTexture((EntityBabyDragon)p_110775_1_);
    }
