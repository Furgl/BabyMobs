...
public class RenderBabyDragon extends RenderLiving<EntityBabyDragon>
{
     ...
     */
    protected void renderModel(EntityBabyDragon entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float p_77036_7_)
    {
     ...
     */
    public void doRender(EntityBabyDragon entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected void drawRechargeRay(EntityBabyDragon dragon, double p_180574_2_, double p_180574_4_, double p_180574_6_, float p_180574_8_)
    {
