...
public class RenderBabyWither extends RenderLiving<EntityBabyWither>
{
    private static final ResourceLocation invulnerableWitherTextures = new ResourceLocation("textures/entity/wither/wither_invulnerable.png");
    private static final ResourceLocation witherTextures = new ResourceLocation("textures/entity/wither/wither.png");

    public RenderBabyWither(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelBabyWither(0.0F), 1.0F);
     ...
     */
    public void doRender(EntityBabyWither entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected void preRenderCallback(EntityBabyWither entitylivingbaseIn, float partialTickTime)
    {
        float f = 2.0F;
