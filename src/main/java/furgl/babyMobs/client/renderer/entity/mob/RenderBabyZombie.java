...
import furgl.babyMobs.client.model.ModelBabyZombie;
...
public class RenderBabyZombie extends RenderBiped
{
    ...
    public RenderBabyZombie(RenderManager p_i46127_1_)
    {
        super(p_i46127_1_, new ModelBabyZombie(), 0.5F, 1.0F);
    ...
    public void func_180579_a(EntityBabyZombie p_180579_1_, double p_180579_2_, double p_180579_4_, double p_180579_6_, float p_180579_8_, float p_180579_9_)
    {
        this.func_82427_a(p_180579_1_);
        super.doRender(p_180579_1_, p_180579_2_, p_180579_4_, p_180579_6_, p_180579_8_, p_180579_9_);
    }

    protected ResourceLocation func_180578_a(EntityBabyZombie p_180578_1_)
    {
        return p_180578_1_.isVillager() ? zombieVillagerTextures : zombieTextures;
    }

    private void func_82427_a(EntityBabyZombie p_82427_1_)
    {
    ...
    protected void rotateCorpse(EntityBabyZombie p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
    ...
    {
        return this.func_180578_a((EntityBabyZombie)entity);
    }
    ...
    {
        this.func_180579_a((EntityBabyZombie)entity, x, y, z, p_76986_8_, partialTicks);
    }

    protected void rotateCorpse(EntityLivingBase p_77043_1_, float p_77043_2_, float p_77043_3_, float p_77043_4_)
    {
        this.rotateCorpse((EntityBabyZombie)p_77043_1_, p_77043_2_, p_77043_3_, p_77043_4_);
    }
