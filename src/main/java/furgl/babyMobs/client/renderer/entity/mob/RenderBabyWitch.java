...
public class RenderBabyWitch extends RenderLiving
{
    ...
    private final ModelBabyWitch witchModel;

    public RenderBabyWitch()
    {
        super(new ModelBabyWitch(0.0F), 0.3F);
        this.witchModel = (ModelBabyWitch)this.mainModel;
    }
     ...
     */
    public void doRender(EntityBabyWitch p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityBabyWitch p_110775_1_)
    {
        return witchTextures;
    }

    protected void renderEquippedItems(EntityBabyWitch p_77029_1_, float p_77029_2_)
    {
    ...
    {
        this.doRender((EntityBabyWitch)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
    }
    ...
    {
        this.renderEquippedItems((EntityBabyWitch)p_77029_1_, p_77029_2_);
    }
    ...
    {
        return this.getEntityTexture((EntityBabyWitch)p_110775_1_);
    }
