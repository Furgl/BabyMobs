...
public class RenderBabyGuardian extends RenderLiving<EntityBabyGuardian>
{    
    ...
    public RenderBabyGuardian(RenderManager renderManagerIn)
    {
        super(renderManagerIn, new ModelBabyGuardian(), 0.5F);
        this.field_177115_a = ((ModelBabyGuardian)this.mainModel).func_178706_a();
    }

    public boolean shouldRender(EntityBabyGuardian livingEntity, ICamera camera, double camX, double camY, double camZ)
    {
     ...
     */
    public void doRender(EntityBabyGuardian entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
     ...
     */
    protected void preRenderCallback(EntityBabyGuardian entitylivingbaseIn, float partialTickTime)
    {
     ...
     */
    protected ResourceLocation getEntityTexture(EntityBabyGuardian entity)
    {
