...
public class RenderBabyGuardian extends RenderLiving
{
    private static final ResourceLocation field_177114_e = new ResourceLocation("babyMobs:textures/entity/baby_guardian.png");
    ...
    public RenderBabyGuardian(RenderManager p_i46171_1_)
    {
        super(p_i46171_1_, new ModelBabyGuardian(), 0.5F);
        this.field_177115_a = ((ModelBabyGuardian)this.mainModel).func_178706_a();
    }

    public boolean shouldRenderBabyGuardian(EntityBabyGuardian p_177113_1_, ICamera p_177113_2_, double p_177113_3_, double p_177113_5_, double p_177113_7_)
    {
        ...
        else
        {
            if (p_177113_1_.func_175474_cn())
            {
                ...
                if (entitylivingbase != null)
                {
                    ...
                    Vec3 vec31 = this.func_177110_a(p_177113_1_, p_177113_1_.getEyeHeight(), 1.0F);
    ...
    public void func_177109_a(EntityBabyGuardian p_177109_1_, double p_177109_2_, double p_177109_4_, double p_177109_6_, float p_177109_8_, float p_177109_9_)
    {
        if (this.field_177115_a != ((ModelBabyGuardian)this.mainModel).func_178706_a())
        {
        ...
        if (entitylivingbase != null)
        {
            ...
            float f4 = p_177109_1_.worldObj.getTotalWorldTime() + p_177109_9_;
    ...
    protected void func_177112_a(EntityBabyGuardian p_177112_1_, float p_177112_2_)
    {
    ...
    protected ResourceLocation func_177111_a(EntityBabyGuardian p_177111_1_)
    {
    ...
    {
        this.func_177109_a((EntityBabyGuardian)entity, x, y, z, p_76986_8_, partialTicks);
    }
    ...
    {
        return this.shouldRenderBabyGuardian((EntityBabyGuardian)p_177104_1_, p_177104_2_, p_177104_3_, p_177104_5_, p_177104_7_);
    }
    ...
    {
        this.func_177112_a((EntityBabyGuardian)p_77041_1_, p_77041_2_);
    }
    ...
    {
        return this.func_177111_a((EntityBabyGuardian)entity);
    }
    ...
    {
        return this.shouldRenderBabyGuardian((EntityBabyGuardian)entity, camera, camX, camY, camZ);
    }
}